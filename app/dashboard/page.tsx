        ...
        <div className="grid grid-cols-1 md: grid-cols-3 gap-6 mb-8">
          ...
          >
            ...
            <p className="text-3xl font-bold text-gray-900">
              {formatRupee(unpaidFees.reduce((sum, fee) => sum + fee.total, 0))}
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-3xl font-bold text-green-600">
              {formatRupee(paidFeesData.reduce((sum, fee) => sum + fee.total, 0))}
            </p>
          </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {unpaidFees.map((fee, index) => (
                ...
                >
                  ...
                  <div className="mb-4">
                    <p className="text-3xl font-bold text-gray-900">{formatRupee(fee. total)}</p>
                      ...
                      >
                        {fee.breakdown.map((item) => (
                          <div key={item.id} className="flex justify-between items-start p-3 bg-gray-50 rounded-lg">
                            ...
                            <p className="font-bold text-gray-900">{formatRupee(item. amount)}</p>
                          </div>
                        ))}
                      </motion.div>
                    )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {paidFeesData. map((fee) => (
                ...
                >
                  ...
                  <p className="text-2xl font-bold text-gray-900">{formatRupee(fee.total)}</p>
                </div>
              ))}
            </div>
          </div>
                ...
                {payments.map((payment) => (
                  ...
                  >
                    ...
                    <p className="text-xl font-bold text-green-600">
                      {typeof payment.amount === 'number' && isFinite(payment.amount) 
        ...
        {selectedFees.length > 0 && (
          ...
          >
            <div className="bg-white rounded-2xl p-6 shadow-2xl border border-gray-200 min-w-[300px]">
              ...
              <p className="text-3xl font-bold text-gray-900 mb-4">{formatRupee(totalAmount)}</p>
              <button
